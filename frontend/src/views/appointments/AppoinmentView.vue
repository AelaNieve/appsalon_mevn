...
<template>
  <div class="flex items-top justify-center min-h-screen bg-gradient-to-br from-pastel-lilac/60 via-muted-grape/40 to-deep-plum/80 py-16 px-4">
    <div
    ...
    >
      ...
      <div class="relative flex flex-col md:flex-row items-center gap-10 bg-gradient-to-r from-pastel-lilac/80 via-muted-grape/60 to-deep-plum/80 p-10">
        <div class="relative">
          <img
            ...
            alt="Decoración"
          />
          <span class="absolute -bottom-2 -right-2 bg-deep-plum text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg animate-bounce">Nuevo</span>
        </div>
        <div class="flex-1">
          <h2 class="text-4xl font-black text-deep-plum mb-3 text-center md:text-left flex items-center gap-3 drop-shadow-lg">
            <span class="text-5xl animate-pulse">🗓️</span>
            <span class="bg-pastel-lilac/70 px-4 py-1 rounded-xl shadow text-dark-indigo">Confirma tu cita</span>
          </h2>
      ...
      <div class="p-8">
        ...
        >
          <span class="inline-flex items-center gap-2 mb-4">
            <svg class="w-7 h-7 text-deep-plum animate-pulse" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
          ...
          <div class="flex justify-center">
            <button
              class="w-full md:w-auto bg-gradient-to-r from-pastel-lilac via-muted-grape to-deep-plum p-4 mt-6 rounded-2xl text-white font-extrabold text-lg shadow-xl ring-2 ring-light-mauve/40
               hover:scale-105 hover:shadow-2xl hover:bg-gradient-to-l focus:outline-none focus:ring-4 focus:ring-pastel-lilac/60 transition-all duration-200 flex items-center justify-center gap-3"
        ...
        <div v-else>
          ...
          <div class="flex justify-end mt-8">
            <div class="bg-gradient-to-r from-deep-plum via-muted-grape to-pastel-lilac text-white rounded-xl px-8 py-4 text-2xl font-bold shadow-lg flex items-center gap-2 ring-2 ring-light-mauve/40">
          ...
          <h1 class="text-3xl font-extrabold text-center my-10 text-deep-plum tracking-tight bg-pastel-lilac/40 rounded-xl py-3 shadow">
          ...
          >
            <button
              ...
              :key="hour"
              class="rounded-lg text-lg font-bold p-3 transition-all duration-200 border-2 border-light-mauve/30 shadow-sm
                disabled:bg-red-300 disabled:text-white disabled:cursor-not-allowed
                hover:scale-105"
              :class="appointments.time == hour
      ...
      <div v-if="appointments.isValidReservation" class="mt-6 flex justify-center px-8 pb-8">
        ...
        >
          <span class="inline-flex items-center gap-2">
            <svg class="w-6 h-6 text-pastel-lilac" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path>
            </svg>

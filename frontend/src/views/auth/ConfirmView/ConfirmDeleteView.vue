  ...
  <div class="bg-deep-plum/60 border border-muted-grape/50 rounded-2xl p-8 sm:p-10 shadow-xl backdrop-blur-sm">
    <div class="flex flex-col items-center justify-center text-center px-4 space-y-6">
      ...
      <div v-if="isLoading" class="space-y-4">
        <h1 class="text-3xl md:text-4xl font-bold text-pastel-lilac">Borrando Cuenta...</h1>
        <p class="text-lg text-light-mauve/90">Por favor espera, tu cuenta está siendo eliminada.</p>
      ...
      <div v-if="deletionStatus === 'success'" class="space-y-4">
        ...
        <h1 class="text-3xl md:text-4xl font-bold text-pastel-lilac">Cuenta Borrada</h1>
        <p class="text-lg text-light-mauve/90">Tu cuenta ha sido permanentemente eliminada.</p>
        <p class="text-md text-muted-grape">
      ...
      <div v-if="deletionStatus === 'error'" class="space-y-4">
        ...
        <h1 class="text-3xl md:text-4xl font-bold text-pastel-lilac">Error al Borrar la Cuenta</h1>
        <p class="text-lg text-light-mauve/90">
          El enlace puede que no sea válido o ya expiró.
        </p>
        <p class="text-md text-muted-grape">
          Redirigiendo a la página de ayuda en: {{ countdown }} segundos...
        </p>
      </div>

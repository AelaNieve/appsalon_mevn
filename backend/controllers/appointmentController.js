...
export const getAppointmentsByDate = async (req, res) => {
  ...
  // FIX: Change the expected date format here
...
export const createAppointmentExample = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(201)
      .json({ msg: "Cita creada exitosamente.", appointment });
  } catch (error) {
    console.error(colors.red.bold(`☠️  Error al crear cita: ${error.message}`));
    return res
      .status(500)
      .json({ msg: "Error interno del servidor al crear la cita." });
  }
};
...
export const getAppointmentExample = async (req, res) => {
  ...
  try {
    ...
    console.error(
      colors.red.bold(`☠️  Error al obtener cita: ${error.message}`)
    );
    return res
      .status(500)
      .json({ msg: "Error interno del servidor al obtener la cita." });
  }
};
...
export const deleteAppointmentExample = async (req, res) => {
  ...
  try {
    ...
    console.error(
      colors.red.bold(`☠️  Error al eliminar cita: ${error.message}`)
    );
    return res
      .status(500)
      .json({ msg: "Error interno del servidor al eliminar la cita." });
  }
};
